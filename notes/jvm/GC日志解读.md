...
## 怎么理解延迟和吞吐量的关系？为什么老师说高延迟吞吐量可能也会高（分布式系统），低延迟也可能吞吐量变低（GC和JVM）？

KK：
1、对于分布式系统，关于微服务对性能的影响。
...
具体可以参考：https://kimmking.blog.csdn.net/article/details/105...

2、上面说的是分布式的情况，对于GC和JVM，更简单。
